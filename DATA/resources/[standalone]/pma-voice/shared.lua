...
if GetConvar('voice_useNativeAudio', 'false') == 'true' then
	...
	Cfg.voiceModes = {
		{2.0, "Nói nhỏ"}, -- Whisper speech distance in gta distance units
		{10.0, "Thường"}, -- Normal speech distance in gta distance units
		{20.0, "Hét to"}, -- Shout speech distance in gta distance units
		{200.0, "LOA PHÁT THANH"},
		{600.0, "SIÊU LOA PHÁT THANH"},
	}
else
	Cfg.voiceModes = {
		{2.0, "Nói nhỏ"}, -- Whisper speech distance in gta distance units
