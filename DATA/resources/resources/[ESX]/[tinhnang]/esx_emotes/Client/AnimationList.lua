...
DP.Expressions = {
   ["Bực bội"] = {"Expression", "mood_angry_1"},
   ["Say"] = {"Expression", "mood_drunk_1"},
   ["Câm"] = {"Expression", "pose_injured_1"},
   ["Điện tử"] = {"Expression", "electrocuted_1"},
   ["Gắt gỏng"] = {"Expression", "effort_1"},
   ["Gắt gỏng 2"] = {"Expression", "mood_drivefast_1"},
   ["Gắt gỏng 3"] = {"Expression", "pose_angry_1"},
   ["Vui mừng"] = {"Expression", "mood_happy_1"},
   ["Bị thương"] = {"Expression", "mood_injured_1"},
   ["Hân hoan"] = {"Expression", "mood_dancing_low_1"},
   ["Thở bằng mồm"] = {"Expression", "smoking_hold_1"},
   ["Không bao giờ nhấp nháy"] = {"Expression", "pose_normal_1"},
   ["Một mắt"] = {"Expression", "pose_aiming_1"},
   ["Ngạc nhiên"] = {"Expression", "shocked_1"},
   ["Ngạc nhiên 2"] = {"Expression", "shocked_2"},
   ["Đang ngủ"] = {"Expression", "mood_sleeping_1"},
   ["Đang ngủ 2"] = {"Expression", "dead_1"},
   ["Đang ngủ 3"] = {"Expression", "dead_2"},
   ["Tự mãn"] = {"Expression", "mood_smug_1"},
   ["Đầu cơ"] = {"Expression", "mood_aiming_1"},
   ["Căng thẳng"] = {"Expression", "mood_stressed_1"},
   ["Hờn dỗi"] = {"Expression", "mood_sulk_1"},
   ["Kỳ dị"] = {"Expression", "effort_2"},
   ["Kỳ dị 2"] = {"Expression", "effort_3"},
}

DP.Walks = {
  ["Người ngoài hành tinh"] = {"move_m@alien"},
  ["Bọc thép"] = {"anim_group_move_ballistic"},
  ["Kiêu ngạo"] = {"move_f@arrogant@a"},
  ["Can đảm"] = {"move_m@brave"},
  ["Binh thương"] = {"move_m@casual@a"},
  ["Binh thương 2"] = {"move_m@casual@b"},
  ["Binh thương 3"] = {"move_m@casual@c"},
  ["Binh thương 4"] = {"move_m@casual@d"},
  ["Binh thương 5"] = {"move_m@casual@e"},
  ["Binh thương 6"] = {"move_m@casual@f"},
  ["Chichi"] = {"move_f@chichi"},
  ["Tự tin"] = {"move_m@confident"},
  ["Cảnh sát"] = {"move_m@business@a"},
  ["Cảnh sát 2"] = {"move_m@business@b"},
  ["Cảnh sát 3"] = {"move_m@business@c"},
  ["Nữ mặc định"] = {"move_f@multiplayer"},
  ["Nam mặc định"] = {"move_m@multiplayer"},
  ["Say"] = {"move_m@drunk@a"},
  ["Say"] = {"move_m@drunk@slightlydrunk"},
  ["Say 2"] = {"move_m@buzzed"},
  ["Say 3"] = {"move_m@drunk@verydrunk"},
  ["Phụ nữ"] = {"move_f@femme@"},
  ["Ngọn lửa"] = {"move_characters@franklin@fire"},
  ["Ngọn lửa 2"] = {"move_characters@michael@fire"},
  ["Ngọn lửa 3"] = {"move_m@fire"},
  ["Chạy trốn"] = {"move_f@flee@a"},
  ["Franklin"] = {"move_p_m_one"},
  ["Xã hội đen"] = {"move_m@gangster@generic"},
  ["Xã hội đen 2"] = {"move_m@gangster@ng"},
  ["Xã hội đen 3"] = {"move_m@gangster@var_e"},
  ["Xã hội đen 4"] = {"move_m@gangster@var_f"},
  ["Xã hội đen 5"] = {"move_m@gangster@var_i"},
  ["Tạo rãnh"] = {"anim@move_m@grooving@"},
  ["Bảo vệ"] = {"move_m@prison_gaurd"},
  ["Còng tay"] = {"move_m@prisoner_cuffed"},
  ["Gót chân"] = {"move_f@heels@c"},
  ["Gót chân 2"] = {"move_f@heels@d"},
  ["Đi bộ đường dài"] = {"move_m@hiking"},
  ["Hipster"] = {"move_m@hipster@a"},
  ["Đi lang thang"] = {"move_m@hobo@a"},
  ["Vội"] = {"move_f@hurry@a"},
  ["Người gác cổng"] = {"move_p_m_zero_janitor"},
  ["Người gác cổng 2"] = {"move_p_m_zero_slow"},
  ["Chạy bộ"] = {"move_m@jog@"},
  ["Lemar"] = {"anim_group_move_lemar_alley"},
  ["Lester"] = {"move_heist_lester"},
  ["Lester2"] = {"move_lester_caneup"},
  ["Người đàn ông ăn"] = {"move_f@maneater"},
  ["Michael"] = {"move_ped_bucket"},
  ["Tiền bạc"] = {"move_m@money"},
  ["Cơ bắp"] = {"move_m@muscle@a"},
  ["Sang trọng"] = {"move_m@posh@"},
  ["Sang trọng 2"] = {"move_f@posh@"},
  ["Nhanh chóng"] = {"move_m@quick"},
  ["Á quân"] = {"female_fast_runner"},
  ["Buồn"] = {"move_m@sad@a"},
  ["Hỗn láo"] = {"move_m@sassy"},
  ["Hỗn láo 2"] = {"move_f@sassy"},
  ["Sợ hãi"] = {"move_f@scared"},
  ["Sexy"] = {"move_f@sexy@a"},
  ["Râm"] = {"move_m@shadyped@a"},
  ["Chậm"] = {"move_characters@jimmy@slow@"},
  ["Đi vênh vang"] = {"move_m@swagger"},
  ["Khó khăn"] = {"move_m@tough_guy@"},
  ["Khó khăn 2"] = {"move_f@tough_guy@"},
  ["Rác"] = {"clipset@move@trash_fast_turn"},
  ["Rác 2"] = {"missfbi4prepp1_garbageman"},
  ["Trevor"] = {"move_p_m_two"},
  ["Rộng"] = {"move_m@bag"},
...
DP.Shared = {
   ...
   ["bắt tay"] = {"mp_ped_interaction", "handshake_guy_a", "Bắt tay", "Bắt tay 2", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteDuration = 3000,
       SyncOffsetFront = 0.9
   }},
   ["bắt tay 2"] = {"mp_ped_interaction", "handshake_guy_b", "bắt tay 2", "bắt tay", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteDuration = 3000
   }},
   ["ôm"] = {"mp_ped_interaction", "kisses_guy_a", "ôm", "ôm 2", AnimationOptions =
   {
       EmoteMoving = false,
       EmoteDuration = 5000,
       SyncOffsetFront = 1.05,
   }},
   ["ôm 2"] = {"mp_ped_interaction", "kisses_guy_b", "ôm 2", "ôm", AnimationOptions =
   {
       EmoteMoving = false,
       EmoteDuration = 5000,
   ...
   ["đưa cho"] = {"mp_common", "givetake1_a", "đưa cho", "đưa cho 2", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteDuration = 2000
   }},
   ["đưa cho 2"] = {"mp_common", "givetake1_b", "đưa cho 2", "đưa cho", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteDuration = 2000
   }},
   ["bóng chày"] = {"anim@arena@celeb@flat@paired@no_props@", "baseball_a_player_a", "Bóng chày", "ném bóng chày"},
   ["ném bóng chày"] = {"anim@arena@celeb@flat@paired@no_props@", "baseball_a_player_b", "Ném bóng chày", "bóng chày"},
   ["dán lên"] = {"random@countryside_gang_fight", "biker_02_stickup_loop", "Dán lên", "gắn bó", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["gắn bó"] = {"missminuteman_1ig_2", "handsup_base", "Dính lên sợ hãi", "dán lên", AnimationOptions =
   {
      EmoteMoving = true,
      EmoteLoop = true,
   }},
   ["cú đấm"] = {"melee@unarmed@streamed_variations", "plyr_takedown_rear_lefthook", "cú đấm", "bị đấm"},
   ["bị đấm"] = {"melee@unarmed@streamed_variations", "victim_takedown_front_cross_r", "bị đấm", "cú đấm"},
   ["cái đầu"] = {"melee@unarmed@streamed_variations", "plyr_takedown_front_headbutt", "cái đầu", "húc đầu"},
   ["húc đầu"] = {"melee@unarmed@streamed_variations", "victim_takedown_front_headbutt", "húc đầu", "cái đầu"},
   ["cái tát 2"] = {"melee@unarmed@streamed_variations", "plyr_takedown_front_backslap", "cái tát 2", "bị tát", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
       EmoteDuration = 2000,
   }},
   ["cái tát"] = {"melee@unarmed@streamed_variations", "plyr_takedown_front_slap", "cái tát", "bị tát", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
       EmoteDuration = 2000,
   }},
   ["bị tát"] = {"melee@unarmed@streamed_variations", "victim_takedown_front_slap", "bị tát", "cái tát"},
   ["bị tát 2"] = {"melee@unarmed@streamed_variations", "victim_takedown_front_backslap", "bị tát 2", "cái tát 2"},
}
