function PlaySoundFrontend(soundId, soundName, setName, p3)
    return Citizen.InvokeNative(0x67C540AA08E4A6F5, soundId, soundName, setName, p3)
end
...
RegisterKeyMapping('menutron', 'Menu Tron', 'keyboard', "GRAVE")
RegisterCommand('menutron', function()
    if GetLastInputMethod(2) and showMenu then
        showMenu = false
...
RegisterNUICallback('triggerAction', function(data, cb)
    ...
    -- Play sound
    PlaySoundFrontend(-1, "NAV", "HUD_AMMO_SHOP_SOUNDSET", 1) -- nó vẫn bth à ? hay lỗi function ?
