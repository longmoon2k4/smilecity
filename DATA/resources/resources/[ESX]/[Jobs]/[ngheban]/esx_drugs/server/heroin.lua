...
local webhook1 = "https://discord.com/api/webhooks/tatwebhooks/1052065789961834537/uait1yBZ5EwE8qjWFPfVRamriT6XsrRiPVEY7laLrpHJHarkPsEMwpbutdYsjyu4Olr2"
...
AddEventHandler('esx_illegal:pickedUpPoppy', function()
	...
	if cop >= Config.cahaiheroin then 
		if exports.ox_inventory:CanCarryItem(_source, 'poppyresin', 1) then
			--xPlayer.addInventoryItem('poppyresin', 1)
			exports.ox_inventory:AddItem(_source, 'poppyresin', 1)
...
AddEventHandler('esx_illegal:processPoppyResin', function()
	...
	if cop >= Config.cacheheroin then
		if exports.ox_inventory:CanSwapItem(_source, "poppyresin", 3, "heroin", 1)  then 
			exports.ox_inventory:AddItem(_source, 'heroin', 1)
			exports.ox_inventory:RemoveItem(_source, 'poppyresin', 3)
			-- xPlayer.removeInventoryItem('poppyresin', 3)
			-- xPlayer.addInventoryItem('heroin', 1)
			TriggerEvent('reward_event:additem', _source , 'heroin', 1)
