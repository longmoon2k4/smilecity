Locales['en'] = {
  ...
  ['noammo'] = 'Không đủ!',
  ['gave_item'] = 'Đưa %sx %s cho %s',
  ['received_item'] = 'Nhận được %sx %s từ %s',
  ['gave_weapon'] = 'Đưa %s cho %s',
  ['gave_weapon_ammo'] = 'Đưa ~o~%sx %s của %s cho %s',
  ['gave_weapon_withammo'] = 'Đưa %s với ~o~%sx %s cho %s',
  ['gave_weapon_hasalready'] = '%s đã có %s',
  ['gave_weapon_noweapon'] = '%s không có vũ khí đó',
  ['received_weapon'] = 'Đã nhận %s từ %s',
  ['received_weapon_ammo'] = 'Đã nhận ~o~%sx %s cho %s từ %s',
  ['received_weapon_withammo'] = 'Đã nhận %s với ~o~%sx %s từ %s',
  ['received_weapon_hasalready'] = '%s đưa cho bạn %s, nhưng bạn đã có vũ khí đó rồi',
  ['received_weapon_noweapon'] = '%s đưa bạn đạn cho %s, nhưng bạn không có vũ khí đó',
  ['gave_account_money'] = 'Đưa $%s (%s) cho %s',
  ['received_account_money'] = 'Đã nhận $%s (%s) từ %s',
  ['amount_invalid'] = 'Số lượng không phù hợp',
  ['players_nearby'] = 'Không có ai gần bạn',
  ['ex_inv_lim'] = 'Đã quá cân %s',
  ['imp_invalid_quantity'] = 'Số lượng không phù hợp',
  ['imp_invalid_amount'] = 'Số lượng không phù hợp',
  ['threw_standard'] = 'Vứt %sx %s',
  ['threw_account'] = 'Vứt $%s %s',
  ['threw_weapon'] = 'Vứt %s',
  ['threw_weapon_ammo'] = 'Vứt %s với ~o~%sx %s',
  ['threw_weapon_already'] = 'Bạn đã có vũ khí này',
  ['threw_cannot_pickup'] = 'Kho đồ đã đầy',
  ['threw_pickup_prompt'] = 'Ấn E để nhặt',

  -- Key mapping
  ['keymap_showinventory'] = 'Mở Inventory',

  -- Salary related
  ['received_salary'] = 'Bạn đã nhận được: $%s',
  ['received_help'] = 'Bạn đã nhận được: $%s',
  ['company_nomoney'] = 'Hết tiền trả rồi',
  ['received_paycheck'] = 'Give money',
  ['bank'] = 'VIKING BANK',
  ['account_bank'] = 'Bank',
  ['account_black_money'] = 'Tiền bẩn',
  ['account_money'] = 'Tiền mặt',

  ['act_imp'] = 'Không thể thực hiện',
  ['in_vehicle'] = 'Không dùng được hành động này trong xe',
