Config = {
  ...
  SpawnOffset     = vector3(0.0,0.0,80.0),   -- global house spawn offset (location + SpawnOffset) (use negative z-value to lower the shells position)
  ...
  PoliceJobs = {
    police = {      -- JOB NAME
      minRank = 10,  -- min rank to raid house
    },
    police2 = {     -- JOB NAME
      minRank = 10,  -- min rank to raid house
    }
