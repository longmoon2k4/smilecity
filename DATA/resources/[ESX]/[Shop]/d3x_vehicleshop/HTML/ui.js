...
$(document).ready(function(){
                    ...
                    html += `<div class="col-4 mb-4">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Thể Loại : <b>`+car.categoryLabel+`</b></p>
                                        <p class="card-text">Giá : <b>`+car.price+`$</b></p>
                                    </div>
                                    <div class="card-footer bg-white border-0 ">
                                        <button type="button" id="action1" data-value="buy" data-model="`+ car.model +`" class="btn btn-danger w-auto btn-lg buy">Mua</button>
                                        <button type="button" id="action2" data-value="test-drive" data-model="`+ car.model +`" class="btn btn-danger w-auto btn-lg test-drive">Thử</button>
                                    </div>
                                </div>
                            </div>`
                    index++;
    ...
    window.addEventListener('message', function(event) {
        ...
        $('#brand').html(`<option selected value="-1">Tất cả xe</option>`)
