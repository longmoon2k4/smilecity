...
Config.Stores = {
    ...
    {
        type = "surgeon",
        coords = vector4(314.650543, -568.443970, 43.282104, 164.409454),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(316.338470, -568.127441, 43.282104),
            vector3(315.547241, -570.646179, 43.282104),
            vector3(312.646149, -569.090088, 43.282104),
            vector3(313.331879, -566.914307, 43.282104)
        }
    }
}
