...
local function setPlayerAppearance2(appearance)
    if appearance then
        --setPlayerModel(appearance.model)
        setPedAppearance(cache.ped, appearance)
    end
...
local function setPlayerModel123(appearance)
    if appearance then
        setPlayerModel(appearance)
        --setPedAppearance(cache.ped, appearance)
    end
end
...
exports("setPlayerAppearance2", setPlayerAppearance2)
exports("setPlayerModel123", setPlayerModel123)
...
client = {
    ...
    setPlayerAppearance2 = setPlayerAppearance2,
    setPlayerModel123 = setPlayerModel123,
