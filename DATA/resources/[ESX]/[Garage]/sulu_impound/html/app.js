$(document).ready(function(){
    ...
    $(document).on("click", "#accept", function(){
        ...
        //console.log(plate, reason, fine, isNaN(fine))
        if (isNaN(fine)){
        ...
        if(date > 3){
            // Error("#date", "lý do phải lớn hơn 10 ký tự")
            return
        }
        $.post("https://sulu_impound/Impound", JSON.stringify({
            plate: plate,
            reason: reason,
            fine: fine,
            date : date,
