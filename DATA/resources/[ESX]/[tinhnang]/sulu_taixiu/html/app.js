document.addEventListener('DOMContentLoaded', function () {
    ...
    if (el) {
        el.addEventListener('keyup', function (event) {
            if (event.key === "Enter") {
                $.post("https://sulu_taixiu/dattai", JSON.stringify({
                    dice: 'tai',
    ...
    if (ek) {
        ek.addEventListener('keyup', function (event) {
            if (event.key === "Enter") {
                $.post("https://sulu_taixiu/datxiu", JSON.stringify({
                    dice: 'xiu',
    ...
    var showStt = function (msg, timeout = 3000) {
        ...
        $.post("https://sulu_taixiu/Notification", JSON.stringify({ message: msg }));
    };
    ...
    $(document).ready(function () {
        ...
        $("body").on("click", ".close", function () {
            $.post("https://sulu_taixiu/Close")
        })
        $("body").on("click", "#esc", function () {
            $.post("https://sulu_taixiu/NUIFocusOff")
        })
    ...
    function closeInventory() {
        $.post("https://sulu_taixiu/NUIFocusOff", JSON.stringify({}));
    }
});	