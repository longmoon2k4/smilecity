...
Config.webhook = "https://discord.com/api/webhooks/tatwebhooks/1052550883952562257/ft2Yu-uY4ozL82VB4w9UCkTW_unkXNtBcIEXIexDz0u6Kj2e-tdoF72pMYE_IMlshVlx"					-- Webhook to send logs to discord
...
Config.contratos = {
	...
	['cargas'] = {
		...
		{ carga = "armytanker", nome = "Xăng cho quân đội", def = {3,0,0}},
		{ carga = "armytanker", nome = "Nước sạch cho quân đội", def = {0,0,0}},
		{ carga = "armytanker", nome = "Vận chuyển vật liệu ăn mòn cho quân đội", def = {6,0,1}},
		{ carga = "armytanker", nome = "Vận chuyển gas cho quân đội", def = {2,0,0}},
		{ carga = "armytanker", nome = "Vận chuyển khí độc cho quân đội", def = {5,0,0}},
		{ carga = "armytanker", nome = "Vận chuyển tài liệu bí mật", def = {0,0,1}},

		{ carga = "liquide1", nome = "Vận chuyển Kali Hydroxit", def = {6,0,0}},
		{ carga = "liquide1", nome = "Vận chuyển Ni tơ", def = {2,0,1}},
		{ carga = "liquide1", nome = "Vận chuyển Kali Clorua", def = {5,0,0}},
		{ carga = "liquide1", nome = "Vận chuyển chất độc", def = {5,0,0}},
		{ carga = "liquide1", nome = "Vận chuyển thuốc trừ sâu", def = {5,0,0}},

		{ carga = "trflat", nome = "Vận chuyển kiện hàng rỗng", def = {0,0,0}},

		{ carga = "tr3", nome = "Vận chuyển máy móc hạng nặng", def = {0,1,1}},
		{ carga = "tr3", nome = "Vận chuyển thuyền lỏ", def = {0,1,1}},
		
		{ carga = "docktrailer", nome = "Vận chuyển đồ đạc", def = {0,0,0}},
		{ carga = "docktrailer", nome = "Vận chuyển tủ đông", def = {0,1,0}},
		{ carga = "docktrailer", nome = "Vận chuyển gạch", def = {0,0,0}},
		{ carga = "docktrailer", nome = "Vận chuyển sản phẩm nhập khẩu", def = {0,0,1}},
		{ carga = "docktrailer", nome = "Vận chuyển nhựa", def = {0,0,0}},
		{ carga = "docktrailer", nome = "Vận chuyển quần áo", def = {0,0,0}},
		{ carga = "docktrailer", nome = "Vận chuyển bàn ghế", def = {0,0,0}},
		{ carga = "docktrailer", nome = "Vận chuyển thiết bị trường học", def = {0,0,0}},
		{ carga = "docktrailer", nome = "Vận chuyển vật tư vệ sinh", def = {0,0,0}},
		{ carga = "docktrailer", nome = "Vận chuyển gỗ tinh chế", def = {0,0,0}},
		{ carga = "docktrailer", nome = "Vận chuyển đá", def = {0,0,0}},
		{ carga = "docktrailer", nome = "Vận chuyển đá quý", def = {0,1,1}},
		{ carga = "docktrailer", nome = "Vận chuyển thủy tinh", def = {0,1,0}},
		{ carga = "docktrailer", nome = "Vận chuyển đạn dược", def = {1,0,0}},
		
		{ carga = "armytrailer", nome = "Trailer empty", def = {0,0,0}},
		...
		{ carga = "tvtrailer", nome = "Vận chuyển thiết bị cho show diễn", def = {0,0,1}},
		{ carga = "tvtrailer", nome = "Vận chuyển vật tư cho sự kiện", def = {0,1,1}},
		
		{ carga = "tanker", nome = "Bình nhiên liệu có phụ gia", def = {3,0,0}},
		{ carga = "tanker2", nome = "Bình xăng cỡ vừa", def = {3,0,0}},
		{ carga = "tanker2", nome = "Bồn chứa dầu hoả", def = {3,0,0}},
		{ carga = "tanker2", nome = "Thùng dầu", def = {3,0,0}},
		
		{ carga = "docktrailer", nome = "Vận chuyển vật liệu bí ẩn", def = {0,1,1}},
		{ carga = "docktrailer", nome = "Vận chuyển vật liệu quý hiếm", def = {0,1,1}},
		{ carga = "docktrailer", nome = "Vận chuyển vũ khí", def = {0,0,1}},
		
		{ carga = "trailerlogs", nome = "Vận chuyển gỗ", def = {0,0,0}},
		...
		{ carga = "trailers", nome = "Vận chuyển vật liệu nổ", def = {1,1,0}},
		{ carga = "trailers", nome = "Vận chuyển mùn cưa", def = {0,0,0}},

		{ carga = "trailers2", nome = "Vận chuyển nho", def = {0,0,0}},
		{ carga = "trailers2", nome = "Vận chuyển thịt lợn tươi sống", def = {0,0,0}},
		{ carga = "trailers2", nome = "Vận chuyển thịt bò tươi sống", def = {0,0,0}},
		{ carga = "trailers2", nome = "Vận chuyển cà rốt", def = {0,0,0}},
		{ carga = "trailers2", nome = "Vận chuyển khoai tây", def = {0,0,0}},
		{ carga = "trailers2", nome = "Vận chuyển sữa tươi nguyên chất", def = {0,0,0}},
		{ carga = "trailers2", nome = "Vận chuyển đồ hộp tươi ngon", def = {0,0,0}},
		...
		{ carga = "trailers2", nome = "Vận chuyển Lavie đóng chai", def = {0,0,0}},
		{ carga = "trailers2", nome = "Vận chuyển phô mai", def = {0,0,0}},

		{ carga = "trailers3", nome = "Vận chuyển gạch ngói", def = {0,0,0}},
		{ carga = "trailers3", nome = "Vận chuyển đường sắt", def = {0,0,0}},
		{ carga = "trailers3", nome = "Vận chuyển bao bì đã qua sử dụng", def = {0,0,0}},
		{ carga = "trailers3", nome = "Vận chuyển gạch lát sàn", def = {0,0,0}},
		{ carga = "trailers3", nome = "Vận chuyển gốm sứ", def = {0,1,0}},
		{ carga = "trailers3", nome = "Vận chuyển phế liệu", def = {0,0,0}},

		{ carga = "trailers4", nome = "Vận chuyển pháo hoa", def = {1,1,0}},
		{ carga = "trailers4", nome = "Vận chuyển vật liệu nổ", def = {1,1,0}},
		{ carga = "trailers4", nome = "Vận chuyển thuốc nổ", def = {1,1,0}},
		{ carga = "trailers4", nome = "Vận chuyển photpho trắng", def = {4,1,0}},
...
Config.concessionaria = {			-- Truck dealership vehicles
	...
	['xhvip'] = {
		['name'] = 'Xe Việt Nam super ultra mega vip',
		['price'] = 10000000,
...
Config.blips = {
	{1208.7109375,-3114.9431152344,5.7480750083923,478,4,"Lái xe tải",0.5 },
}